...
$(function () {
	...
	$(document).on("click", '#myonoffswitch20', function () {
		if (this.checked) {
			...
			(document.getElementById("style")?.setAttribute("href", "../build/plugins/bootstrap/css/bootstrap.rtl.min.css"));
	...
	$(document).on("click", '#myonoffswitch19', function () {
		...
		if (this.checked) {
			...
			$("head link#style").attr("href", $(this));
			(document.getElementById("style")?.setAttribute("href", "../build/plugins/bootstrap/css/bootstrap.min.css"));
			var carousel = $('.owl-carousel');
			$.each(carousel, function (index, element) {
				// element == this
				var carouselData = $(element).data('owl.carousel');
